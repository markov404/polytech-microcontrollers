...
int main(void)
{
	...
	{
//.............................Работа с V1...........................................
		//Подключение к V1                      Выбор PA5/ADC5                       
		ADMUX|=(1<<MUX0)|(1<<MUX2);     //    MUX2  MUX1   MUX0 
		ADMUX&=~(1<<MUX1);              //      1     0      1
		//Измерение, преобразование кода в напряжение, вывод на дисплей
		ADCconvert();
		volt=cod*4.89;//volt=(cod*5/1023)*1000
		volt=volt*10;//Для V1 спользуется делитель напряжения на 10
		setpos_to_LCD(3,0);
		Volt_to_Display();
//.............................Работа с V2...........................................		
		//Подключение к V2                      Выбор PA6/ADC6    
		ADMUX|=(1<<MUX1)|(1<<MUX2);    //    MUX2  MUX1   MUX0 
		ADMUX&=~(1<<MUX0);             //      1     1      0
		//Измерение и вывод на дисплей
		ADCconvert();
		volt=cod*4.89;//volt=(cod*5/1023)*1000
		volt=volt*4;//Для V2 спользуется делитель напряжения на 4
		setpos_to_LCD(11,0);
		Volt_to_Display();
//....................................................................................
	}
