...
unsigned char n,i=-1;//Вспомогательные переменные
char Cod_preset[]={4,5,7,8,9,0};//Maccив c установленным кодом
char Cod_input[6];//Массив с входным кодом
...
//........Выполнять условие только если были нажатия кнопок..........
	...
	//...............Действия после ввода пароля.......................
		if(i==5)//Когда чисто нажатий кнопок достигло трех
		{
		i=-1;//Обнулить число нажатий кнопок
